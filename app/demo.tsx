            ...
            {data?.fiyatlar.map((item: any) => (
              <Table.Row key={item.ilce}>
                ...
                <Table.RowHeaderCell className="whitespace-nowrap">
                  {item.benzin} <span className="opacity-40 text-sm">TL</span>
                </Table.RowHeaderCell>
                <Table.RowHeaderCell className="whitespace-nowrap">
                  {item.mazot} <span className="opacity-40 text-sm">TL</span>
                </Table.RowHeaderCell>
                <Table.RowHeaderCell className="whitespace-nowrap">
                  {item.lpg} <span className="opacity-40 text-sm">TL</span>
                </Table.RowHeaderCell>
              </Table.Row>
            ))}
          </Table.Body>
